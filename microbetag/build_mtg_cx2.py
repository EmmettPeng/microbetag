...
def init_nodes_and_edges(edgelist: pd.DataFrame, seq_id_to_taxonomy: Dict[str, str], config=None):
    """
...
# NETWORK
# -----------------------------
# TODO (Haris Zafeiropoulos, 2025-05-07): check Dict
def build_cx2(nodes: Dict[str, Dict], edges: Dict[str, Dict]):
    """
